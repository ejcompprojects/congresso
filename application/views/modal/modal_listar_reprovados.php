    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="" id="form">
          ...
          <div class="form-group">
            <label class="form-control-label">Data da Submissão:</label>
            <input type="text" name="data_submissao" id="data_submissao" class="form-control" disabled>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="nota" id="nota" class="form-control" disabled>
          </div>

          <div class="form-group">
            <label class="form-control-label">Data Parecer:</label>
            <input type="text" name="data_parecer" id="data_parecer" class="form-control" disabled>
          </div>

          <div class="form-group">
            <label class="form-control-label">Parecerista</label>
            <input type="text" name="parecerista" id="parecerista" class="form-control" disabled>
          </div>
