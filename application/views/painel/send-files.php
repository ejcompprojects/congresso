<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<?php 
	if(isset($div_status_comprovante) && $div_status_comprovante){
		?>
		<div class="col-md-12">
			<div class="panel <?= $status_comprovante['panel'] ?>">
				<div class="panel-heading">
					<p align="center" style="color:white;">Status do Pagamento: <?= $status_comprovante['label'] ?></p>


					<span class="pull-right"></span></div>
					<div class="panel-body">
						<h2><?= $status_comprovante['title'] ?></h2>
						<?php if (array_key_exists("subtitle",$status_comprovante)){
							echo $status_comprovante['subtitle'];
						}
						?>
					</div>
		...
		if(isset($div_enviar_comprovante) && $div_enviar_comprovante){
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" action="<?= base_url('Painel/send_photo') ?>" method="post" enctype="multipart/form-data">
								<fieldset>
									...
									<p><strong>3</strong> - Selecione abaixo a foto do comprovante de depósito. Os tipos de imagens permitidos são: <strong>.pdf, .jpg, .jpeg, .gif, .bmp, .png.</strong> com o tamanho máximo de <strong>6 MB.</strong></p>
			...
			if(isset($div_alerta_trabalho) && $div_alerta_trabalho){
				?>
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
			...
			if(isset($div_status_trabalho) && $div_status_trabalho){
				?>
				
				<div class="col-md-12">
					<div class="panel <?= $status_trabalho['panel'] ?>">
						<div class="panel-heading">
							<p align="center" style="color:white;"><?= $status_trabalho['label'] ?></p>


							<span class="pull-right"></span>
						</div>
						<div class="panel-body">
							<h2><?= $status_trabalho['title'] ?></h2>
							<?php if (array_key_exists("subtitle",$status_trabalho)){
							echo $status_trabalho['subtitle'];
						}
						?>
						</div>
			...
			if(isset($div_enviar_trabalho) && $div_enviar_trabalho){
				?>
				<div class="col-md-12">
					<div class="panel panel-default">
						<div class="panel-heading">
						...
						<div class="panel-heading" id="duvida">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" action="<?= base_url('Painel/send_article') ?>" method="POST" enctype="multipart/form-data">
									<fieldset>
										<p><strong>OBS:</strong> O formato válido para o arquivo dos artigos são: <strong>.pdf, .doc, .docx.</strong> com a tamanho máximo de <strong>6 MB.</strong></p>
							...
							<div class="panel-body">
								...
								<form class="form-horizontal" action="<?= base_url('Painel/resend_article') ?>" method="POST" enctype="multipart/form-data">
									<fieldset>
										...
										<?php if($status_reenvio == 'COM' || $status_reenvio == 'AMBOS'){ ?>
										...
										<?php if($status_reenvio == 'SEM' || $status_reenvio == 'AMBOS'){ ?>
