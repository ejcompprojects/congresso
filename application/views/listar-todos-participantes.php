    ...
    <div class="col-md-12">
      <div class="content-panel">
        ...
        <div class="col-sm-12 message">
            ...
            <!-- tbody -->
              ...
              foreach ($participantes as $participante) :
                ...
                switch($participante->status_inscricao){
                 case 0: $participante->status_inscricao_label = 'Pendente'; break;

                 case 1: $participante->status_inscricao_label = 'Aprovado'; break;
             ...
             //  case 2: $participante->status = 'Reprovado'; break;
              ...
              <tr>
                ...
                <td>
                  ...
                  data-eixo      ="<?=$participante->id_eixo?>"
                  ...
                  <i class="fa fa-eye"></i>
                          ...
                          $input[16]['type']  = "select_especial";

                          $input[16]['label'] = "Eixo";
                          $input[16]['content'] = $eixos;
                          $input[16]['attr']  = array(
                            'name'        => 'eixo',
                            'id'          => 'eixo',
                            'maxlength'   => 255,
          ...
          modal.find('#id').show()
          modal.find('#formParticipante').attr("action", "<?=base_url('Participante/alterar_dados/')?>")
          ...
          if(titulo == ''){ //quer dizer que o usu´rio não submeteu o artigo
            ...
            modal.find('#eixo').parent().parent().hide();

            modal.find('#status').parent().parent().hide();

            modal.find('#data_registro').parent().hide();

          }else{
            modal.find('#titulo').parent().show();

            modal.find('#arquivo_sem_nome_autor').parent().parent().show();

            modal.find('#arquivo_com_nome_autor').parent().parent().show();

            modal.find('#eixo').parent().show();

            modal.find('#status').parent().show();

            modal.find('#data_registro').parent().show();
